let control = {
	getLanguages: (url, lang) => {
		let itemTpl = view.getTpl("/admin/snippets/lang.item");
		let list = [];
	...
	getCurrentPage: (url) => {
		let blockTpl = view.getTpl("/admin/snippets/menu.block");
		let itemTpl = view.getTpl("/admin/snippets/menu.item");
		let blocks = [];
		let list = [];
	...
	getPagesLayout: (page) => {
		let list = [];
		let itemTpl = view.getTpl("/admin/snippets/pages.list.item");
	...
	getPageTypes: async() => {
		...
		let itemTpl = view.getTpl("/admin/snippets/pages.types.item");
