var api = {
	...
	resp: (e) => {
		...
		if(modules[data.module] !== undefined && modules[data.module].methods !== undefined && typeof modules[data.module].methods[data.method] === "function"){
			modules[data.module].methods[data.method](data);
		}
	}
};